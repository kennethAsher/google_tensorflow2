...
model.add(keras.layers.AlphaDropout(rate=0.5))   #rate，丢掉单元的比例是多少
# model.add(keras.layers.Dropout(rate=0.5))     # 传统的Dropout
'''
AlphaDropout效果更好：（使用更多，更适合在批归一化操作中）
1.均值和方差不变
2.归一化性质不会变，
'''
